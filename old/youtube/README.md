...
```
composer require confrariaweb/youtube
```
...
'providers' => [
    ...
    ConfrariaWeb\Youtube\YoutubeServiceProvider::class,
],
```
...
'aliases' => [
    ...
    'Youtube' => ConfrariaWeb\Youtube\Facades\Youtube::class,
],
```
...
```
php artisan vendor:publish --provider="ConfrariaWeb\Youtube\YoutubeServiceProvider"
```
